...
var utils = exports;
var BN$$1 = __webpack_require__(2);
...
function intFromLE(bytes$$1) {
  return new BN$$1(bytes$$1, 'hex', 'le');
}
...
EC.prototype.genKeyPair = function genKeyPair(options) {
  ...
  do {
    var priv = new BN$$1(drbg.generate(bytes$$1));
    if (priv.cmp(ns2) > 0)
      continue;
...
var secp256k1 = elliptic$1.ec('secp256k1');
...
var secp256k1$1 = elliptic$1.ec('secp256k1');
/**
 ...
 */
var encryptPrivateKey = function (kdf, privateKey, passphrase) { return __awaiter(_this, void 0, void 0, function () {
 ...
 * @returns {Promise<string>}
 */
var decryptPrivateKey = function (passphrase, keystore) { return __awaiter(_this, void 0, void 0, function () {
...
export { sign$1 as sign, schnorr, getAddressFromPrivateKey, getPubKeyFromPrivateKey, compressPublicKey, getAddressFromPublicKey, toChecksumAddress, isValidChecksumAddress, verifyPrivateKey, encryptPrivateKey, decryptPrivateKey, randomBytes, Signature };
