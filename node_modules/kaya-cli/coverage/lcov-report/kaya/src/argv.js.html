...
<html lang="en">
<head>
    <title>Code coverage report for kaya/src/argv.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">kaya/src</a> argv.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const config = require('./config');
&nbsp;
module.exports = exports = <span class="fstat-no" title="function not covered" >fu</span>nction(yargs) {
